...
This is a sample template for sam-build - Below is a brief explanation of what we have generated for you:
...
```bash
sam logs -n HelloWorldFunction --stack-name sam-build --tail
```
...
```bash
aws cloudformation delete-stack --stack-name sam-build
```
